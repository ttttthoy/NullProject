...
public class bookInfoController {
	...
	public String specificBookInfo(Model model, HttpSession session) throws Exception {
...
//		System.out.println(n_list);
	...
	@ResponseBody
	public String bookInfo(@RequestParam(name="isbn") String isbn, Model model, HttpSession session) throws Exception {
